...
### Fighting a Vehicle
Unlike normal melee combat, unless the vehicle has the WALKER keyword, do not make a hit roll for melee attacks, they are considered automatically succesfull. Like ranged weapons in short range, you may chose the location that is hit by each melee attack, unless that vehicle has the WALKER keyword in which case you must choose the legs until the legs have been destroyed. See [Armor Facing and Damage](#armor-facing-and-damage) for what to do next. 
