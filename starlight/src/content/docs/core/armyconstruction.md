...
description: An overview of how to build an army in 0th Edition.
---

### 1. Select Battle Size
With your opponent, select a battle size to determine how many points you can each bring to the table. Some common battle sizes are 1000pts, 2000pts and 3000pts. For every 1000pts, each player gets 2CP that does not go away at the end of the turn that they can also spend on upgrades such as relics/warlord traits when making their army. If playing at less than 1000pts, you get 2CP even though you did not reach the 1000pt threshold. 

### 2. Select Army Faction
Select which faction you are constructing an army for. You may only select units from your faction, with exception of certain allies that have rules that allow you to ally them in despite not having your faction keyword.
